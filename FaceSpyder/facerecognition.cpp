...
void FaceRecognition::LoadImage(const QString &filename)
{
    ...
    connect(mDetectionThread,
            &QThread::started,
            mDetectionWorker,
            &FaceDetectionWorker::processImage);
    connect(mDetectionWorker, &FaceDetectionWorker::finished, mDetectionThread, &QThread::quit);
    connect(mDetectionWorker,
            &FaceDetectionWorker::finished,
            mDetectionWorker,
            &QObject::deleteLater);
    connect(mDetectionThread, &QThread::finished, mDetectionThread, &QObject::deleteLater);
    connect(this,
            &FaceRecognition::requestStopProcessing,
            mDetectionWorker,
            &FaceDetectionWorker::stopProcessing);

    // Connect the signal for detected faces to a slot in your main class
    connect(mDetectionWorker,
            &FaceDetectionWorker::faceDetected,
            this,
            &FaceRecognition::AddDetectedFace);
...
void FaceRecognition::LoadVideo(const QString &filename, QWidget *parent)
{
    ...
    connect(mDetectionThread,
            &QThread::started,
            mDetectionWorker,
            &FaceDetectionWorker::processVideo);
    connect(mDetectionWorker, &FaceDetectionWorker::finished, mDetectionThread, &QThread::quit);
    connect(mDetectionWorker,
            &FaceDetectionWorker::finished,
            mDetectionWorker,
